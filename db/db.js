...
export async function createBrew(userId, roastery, region, coffee_amount, roast_type, brew_method) {
  const text = 'INSERT INTO brews(user_id, roastery, region, coffee_amount, roast_type, brew_method) VALUES($1, $2, $3, $4, $5, $6) RETURNING *';
  const values = [userId, roastery, region, coffee_amount, roast_type, brew_method];
